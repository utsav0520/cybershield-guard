        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {tiers.map((tier, index) => (
              ...
              >
                <div
                  className={`relative h-full flex flex-col rounded-lg border-2 p-6 transition-all ${
                    tier.popular
                ...
                >
                  ...
                  <Button
                    ...
                    className={`w-full ${tier.popular ? "border-background text-background hover:bg-background hover:text-foreground" : ""}`}
                  >
                    {tier.cta}
                  </Button>
                </div>
